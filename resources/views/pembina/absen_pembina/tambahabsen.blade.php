...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-primary">
      ...
      <form action="{{ url('pembina/absen_pembina/tambah') }}" method="POST">
        @csrf
        <div class="box-body">
        ...
        <div class="box-footer">
          ...
          <a href="{{ url('pembina/absen_pembina/index') }}" class="btn btn-default">Kembali</a>
        </div>
      </form>
    </div>
  </section>
