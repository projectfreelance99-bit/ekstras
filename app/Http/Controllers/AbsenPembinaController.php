...
class AbsenPembinaController extends Controller
{
    public function index()
    {
        $absensi = AbsenPembina::with('pembina')->get();
        return view('admin/absen_pembina/index', compact('absensi'));
    }
    ...
    public function updateVerifikasi(Request $request, $id)
    {
        ...
        return redirect('admin/absen_pembina/index')->with('success', "verifikasi berhasil");
    }

    public function tambahabsen()
    {
        $pembina = Pembina::all();
        return view('admin/absen_pembina/tambahabsen', compact('pembina'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/absen_pembina/index')->with('success', "Data sukses ditambahkan");
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.absen_pembina.edit', compact('absensi', 'pembinas'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/absen_pembina/index')->with('success', "Data sukses diperbarui");
    }

    public function delete($id)
    {
        AbsenPembina::destroy($id);
        return redirect('admin/absen_pembina/index')->with('success', "Data sukses dihapus");
    }
}
