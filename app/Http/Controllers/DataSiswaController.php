...
class DataSiswaController extends Controller
{
    public function index()
    {
        ...
        return view('siswa/siswa/index',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $data->save();
        return redirect('siswa/siswa/index')->with('success', "Data admin sukses ditambah");
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('siswa/siswa/index')->with('success', "Data siswa berhasil diperbarui.");
    }
    ...
    public function delete($id)
    {
        ...
        return redirect('siswa/siswa/index')->with('success', "Data siswa berhasil dihapus.");
    }
}
